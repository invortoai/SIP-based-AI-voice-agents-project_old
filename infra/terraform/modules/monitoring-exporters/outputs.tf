...
output "postgres_exporter_task_definition_arn" {
  ...
  value = var.enable_postgres_exporter ? try(
    aws_ecs_task_definition.postgres_exporter[0].arn,
    null
  ) : null
}
...
output "redis_exporter_task_definition_arn" {
  ...
  value = var.enable_redis_exporter ? try(
    aws_ecs_task_definition.redis_exporter[0].arn,
    null
  ) : null
}
...
output "node_exporter_task_definition_arn" {
  ...
  value = var.enable_node_exporter ? try(
    aws_ecs_task_definition.node_exporter[0].arn,
    null
  ) : null
}
...
output "app_metrics_exporter_task_definition_arn" {
  ...
  value = var.enable_app_metrics_exporter ? try(
    aws_ecs_task_definition.app_metrics_exporter[0].arn,
    null
  ) : null
}
...
output "postgres_exporter_service_name" {
  ...
  value = var.enable_postgres_exporter ? try(
    aws_ecs_service.postgres_exporter[0].name,
    null
  ) : null
}
...
output "redis_exporter_service_name" {
  ...
  value = var.enable_redis_exporter ? try(
    aws_ecs_service.redis_exporter[0].name,
    null
  ) : null
}
...
output "node_exporter_service_name" {
  ...
  value = var.enable_node_exporter ? try(
    aws_ecs_service.node_exporter[0].name,
    null
  ) : null
}
...
output "app_metrics_exporter_service_name" {
  ...
  value = var.enable_app_metrics_exporter ? try(
    aws_ecs_service.app_metrics_exporter[0].name,
    null
  ) : null
}
