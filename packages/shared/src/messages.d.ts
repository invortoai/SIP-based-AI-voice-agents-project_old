...
export type ServerToClientMessage = SttPartialMessage | SttFinalMessage | LlmDeltaMessage | ToolCallMessage | TtsChunkMessage | ControlBargeInMessage | EmotionWindowMessage | EmotionStateMessage | ConnectedMessage | PongMessage | ErrorMessage | EndMessage;
